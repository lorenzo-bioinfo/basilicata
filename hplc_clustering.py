...
#getting hplc data
hplc_df = pd.read_csv('./dati_hplc/hplc_data.tsv', sep = '\t', header = 0, index_col = 0)

#removing non-molecule columns
df_toclust = hplc_df.drop(['Year', 'Spec'], axis = 1)
print(df_toclust)
...
plt.savefig('./plots/hplc_clustering/hplc_clust_full_magma.png', dpi = 300)
plt.clf()
...
plt.savefig('./plots/hplc_clustering/hplc_clust_full_viridis.png', dpi = 300)
plt.clf()
...
plt.savefig('./plots/hplc_clustering/hplc_clust_full_mako.png', dpi = 300)
plt.clf()
...
index_col = clusterfig.dendrogram_col.reordered_ind #molecule
index_row = clusterfig.dendrogram_row.reordered_ind #sample
plt.savefig('./plots/hplc_clustering/hplc_clust_full(norm)_magma.png', dpi = 300)
plt.clf()
...
plt.savefig('./plots/hplc_clustering/hplc_clust_full(norm)_viridis.png', dpi = 300)
plt.clf()
...
plt.savefig('./plots/hplc_clustering/hplc_clust_full(norm)_mako.png', dpi = 300)
plt.clf()